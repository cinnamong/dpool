                                    ...
                                    <table width="100%" height="100%" border="0" cellspacing="1" cellpadding="0">
                                      <tr>
                                        <td align="center" valign="top" bgcolor="#FFFFFF">
                                          ...
                                          <?
                                          $nowposi = "페이지관리 &gt; <strong>기타페이지</strong>";
                                          include "../inc/nowposi.inc";
                                          ?>
                                          <table width="97%" border="0" cellspacing="0" cellpadding="0">
                                            <tr>
                                              <td height="25"><img src="../image/mark_arrowR.gif" width="12" height="12"> <strong>기타페이지 </strong></td>
                                            </tr>
                                          </table>
                                          <table width="97%" border="0" cellspacing="0" cellpadding="0">
                                            ...
                                            <tr>
                                              <td bgcolor="D5D3D3">
                                                <table width="100%" border="0" cellspacing="1" cellpadding="2">
                                                  <tr> 
                                                   <td width="150" height="25" align="left" bgcolor="EAEAEA">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;사이트맵</td>
                                                  ...
                                                  <tr> 
                                                   <td width="150" height="25" align="left" bgcolor="EAEAEA">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;로그인</td>
                                                   <td width="550" bgcolor="F8F8F8" colspan="3">
                                                    <?
                                                    $type = "login";
																	 $sql = "select * from wiz_page where type='$type'";
                                                  ...
                                                  <tr> 
                                                   <td width="150" height="25" align="left" bgcolor="EAEAEA">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;마이쇼핑</td>
                                                   <td width="550" bgcolor="F8F8F8" colspan="3">
                                                    <?
                                                    $type = "myshop";
																	 $sql = "select * from wiz_page where type='$type'";
                                                  ...
                                                  <tr> 
                                                   <td width="150" height="25" align="left" bgcolor="EAEAEA">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;주문입력</td>
                                                   <td width="550" bgcolor="F8F8F8" colspan="3">
                                                    <?
                                                    $type = "orderform";
																	 $sql = "select * from wiz_page where type='$type'";
                                                  ...
                                                  <tr> 
                                                   <td width="150" height="25" align="left" bgcolor="EAEAEA">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;결제하기</td>
                                                   <td width="550" bgcolor="F8F8F8" colspan="3">
                                                    <?
                                                    $type = "orderpay";
																	 $sql = "select * from wiz_page where type='$type'";
                                                  ...
                                                  <tr> 
                                                   <td width="150" height="25" align="left" bgcolor="EAEAEA">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;주문완료</td>
                                                   <td width="550" bgcolor="F8F8F8" colspan="3">
                                                    <?
                                                    $type = "ordercom";
																	 $sql = "select * from wiz_page where type='$type'";
                                                  ...
                                                  <tr> 
                                                   <td width="150" height="25" align="left" bgcolor="EAEAEA">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;상품검색</td>
                                                   <td width="550" bgcolor="F8F8F8" colspan="3">
                                                    <?
                                                    $type = "prdsearch";
																	 $sql = "select * from wiz_page where type='$type'";
                                                  ...
                                                  <tr> 
                                                   <td width="150" height="25" align="left" bgcolor="EAEAEA">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;신상품</td>
                                                   <td width="550" bgcolor="F8F8F8" colspan="3">
                                                    <?
                                                    $type = "new";
																	 $sql = "select * from wiz_page where type='$type'";
                                                  ...
                                                  <tr> 
                                                   <td width="150" height="25" align="left" bgcolor="EAEAEA">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;추천상품</td>
                                                   <td width="550" bgcolor="F8F8F8" colspan="3">
                                                    <?
                                                    $type = "recom";
																	 $sql = "select * from wiz_page where type='$type'";
                                                  ...
                                                  <tr> 
                                                   <td width="150" height="25" align="left" bgcolor="EAEAEA">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;인기상품</td>
                                                   <td width="550" bgcolor="F8F8F8" colspan="3">
                                                    <?
                                                    $type = "popular";
																	 $sql = "select * from wiz_page where type='$type'";
                                                  ...
                                                  <tr> 
                                                   <td width="150" height="25" align="left" bgcolor="EAEAEA">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;세일상품</td>
                                                   <td width="550" bgcolor="F8F8F8" colspan="3">
                                                    <?
                                                    $type = "sale";
																	 $sql = "select * from wiz_page where type='$type'";
